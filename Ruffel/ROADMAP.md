...
- [x] Ollama provider — mature, tested, documented
- [x] Arch Linux support — native pacman installer, Ollama mode default
- [x] OpenCode ↔ OpenMono fallback system — `agent` CLI switcher
- [x] GitHub Actions CI for .NET builds
- [x] Architecture-independent Ollama mode (no VRAM minimum)
