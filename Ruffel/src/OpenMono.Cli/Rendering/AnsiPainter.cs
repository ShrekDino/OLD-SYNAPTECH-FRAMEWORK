...
public sealed partial class AnsiPainter(AppConfig config, SessionState session, ITerminal terminal)
{
    ...
    public void SetBgInputProvider(Func<string> getter) => _getBgInput = getter;
