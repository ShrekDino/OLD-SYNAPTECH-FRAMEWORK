...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 60 * 120;
        ...
        genesis = CreateGenesisBlock(1717200000, 4026531825, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x260ab26d887b9e15ba8686e21dd49c9d7da2ecae3a1dcb65fd2f2b94033d0a1c"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));

        // No DNS seeds — this is an independent network
        vSeeds.clear();

        // Address prefixes same as Bitcoin mainnet for maximum compatibility
